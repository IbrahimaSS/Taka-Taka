      ...
      (error) => {
        ...
        switch (error.code) {
          case error.PERMISSION_DENIED:
            toast.error('Veuillez activer la géolocalisation dans les paramètres de votre navigateur', { id: 'location-error' });
            break;
          case error.POSITION_UNAVAILABLE:
            toast.error('Position indisponible. Vérifiez votre connexion GPS', { id: 'location-error' });
            break;
          case error.TIMEOUT:
