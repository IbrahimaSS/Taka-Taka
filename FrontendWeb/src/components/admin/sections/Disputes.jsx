...
const Disputes = () => {
  ...
  const renderStatus = (status) => {
    const config = {
      open: { label: 'Ouvert', color: 'danger', icon: AlertTriangle },
      in_progress: { label: 'En cours', color: 'warning', icon: Hourglass },
      resolved: { label: 'Résolu', color: 'success', icon: CheckCircle },
      rejected: { label: 'Rejeté', color: 'danger', icon: XCircle },
      pending: { label: 'En attente', color: 'secondary', icon: Clock }
    };

    const { label, color, icon: Icon } = config[status] || config.pending;
    return (
      <Badge className={`text-${color} bg-${color}-100`}>
          ...
          {paginatedDisputes.map((dispute) => (
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  <div className="font-bold text-gray-800">{dispute.id}</div>
              ...
              <div>
                <p className="font-medium text-gray-800 text-sm">{dispute.title}</p>
                <p className="text-gray-500 text-xs mt-1">{dispute.description}</p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-700">{dispute.users.passenger}</span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center mr-2">
                    <Car className="text-blue-500 text-xs" />
                  </div>
                  <span className="text-sm text-gray-700">{dispute.users.driver}</span>
                </div>
              </div>
      ...
      >
        {paginatedDisputes.map((dispute) => (
          <TableRow key={dispute.id}>
            ...
            <TableCell>
              <div className="font-medium text-gray-800">{dispute.id}</div>
        ...
        <div className="space-y-6 scroll-me-t-2 overflow-auto h-[70vh]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-2">Trajet concerné</h3>
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center justify-center mb-2 gap-10">
                    <div className="flex items-center">
                      <div className='text-xm text-gray-500'> ID: 
                      <p className="font-medium"> {dispute.tripId}</p></div>
                    </div>
                    <div className='text-gray-900 text-sm font-medium'>Depart <p>Mamou</p></div>
                    <div className='text-gray-900 text-sm font-medium'>Destination <p>Kankan</p></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-2">Parties concernées</h3>
                <div className="space-y-3">
                  <div className="bg-green-50 rounded-lg p-3">
                    ...
                    <p className="text-sm font-medium">{dispute.users.passenger}</p>
                    <p className="text-xs text-gray-500">{dispute.users.passengerId}</p>
                  </div>
                  <div className="bg-blue-50 rounded-lg p-3">
                    ...
                    <p className="text-sm font-medium">{dispute.users.driver}</p>
                    <p className="text-xs text-gray-500">{dispute.users.driverId}</p>
                  </div>
                </div>
              </div>
          ...
          {dispute.evidence && dispute.evidence.length > 0 && (
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-2">Preuves jointes</h3>
          ...
          {/* Commentaires */}
          <div>
            <h3 className="text-sm font-medium text-gray-500 mb-2">Historique des commentaires</h3>
            <div className="space-y-3">
  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      ...
      >
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Gestion des litiges</h1>
          <p className="text-gray-500 text-sm md:text-base">Résolvez les problèmes signalés par les utilisateurs</p>
        </div>
