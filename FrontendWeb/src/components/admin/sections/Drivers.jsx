  ...
  const stats = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        description: 'Basée sur tous les avis',
      },
    ];
  }, [drivers]);
        ...
        {selectedDriver ? (
          <div className="space-y-6 scroll-m-t-2 overflow-auto h-[70vh] pr-2">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-800">{selectedDriver.name}</h3>
                <p className="text-gray-500 text-sm">{selectedDriver.email}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 pt-4 border-t border-gray-200 ms-8">
              <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-xl p-4">
                <p className="text-sm text-gray-500 mb-2">Véhicule</p>
                <p className="text-xl font-bold text-gray-800 mb-1">{selectedDriver.vehicle}</p>
                <p className="text-gray-600">{selectedDriver.plate}</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-4">
                <p className="text-sm text-gray-500 mb-2">Note moyenne</p>
                <div className="flex items-center">
                  <Star className="w-5 h-5 text-yellow-400 fill-current" />
                  <span className="ml-2 text-2xl font-bold text-gray-800">{selectedDriver.rating}</span>
                  <span className="ml-2 text-gray-500">/5</span>
                </div>
                <p className="text-gray-600 mt-1">{selectedDriver.trips} trajets effectués</p>
              </div>
            </div>
            ...
            {/* Revenus */}
            <div className="pt-4 border-t border-gray-200">
              <p className="text-sm font-medium text-gray-700 mb-3">Revenus totaux</p>
          ...
          <div className="text-center py-8">
            <p className="text-gray-500">Aucun chauffeur sélectionné</p>
          </div>
        )}
      </Modal>
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
              <div className="relative lg:w-[350px]">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:border-green-400 focus:ring-2 focus:ring-green-100 outline-none transition text-base"
                  value={searchTerm}
                  onChange={handleSearch}
                />
              </div>
              <div className='relative lg:ms-20'>
                <select
                  className="w-full  lg:w-[200px]  border border-gray-200 rounded-lg py-3 pr-10  text-sm outline-none focus:border-green-400 transition"
              ...
              <div className='relative '>
                <select
                  className="border border-gray-200  rounded-lg py-3 pr-10 w-full  lg:w-[200px] text-sm outline-none focus:border-green-400 transition"
            ...
            {(searchTerm || activeFilterCount > 0) && (
              <div className="flex flex-wrap gap-2 pt-2">
                {searchTerm && (
                  <div className="inline-flex items-center bg-green-50 text-green-700 px-3 py-1.5 rounded-full text-sm">
                ...
                {Object.entries(selectedFilters).map(([key, value]) => {
                  ...
                  let label = value;
                  if (key === 'status') {
                    label = filterOptions.status.find(opt => opt.value === value)?.label || value;

                  } else if (key === 'type') {
                    label = filterOptions.type.find(opt => opt.value === value)?.label || value;
                  }

                  return (
                    <div
                      key={key}
                      className="inline-flex items-center bg-green-50 text-green-700 px-3 py-1.5 rounded-full text-sm"
                    >
          ...
          <Card>
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">Essayez de modifier vos critères de recherche ou de filtres</p>
                <Button
                  variant="secondary"
                  onClick={clearFilters}
                  className="mt-4"
          ...
          <>
                ...
                >
                  <Card hoverable className="p-6">
                    <div className="flex items-center justify-between  mb-4">
                      <div className="flex items-center">
                        ...
                        <div className="min-w-0">
                          <h4 className="font-bold text-gray-800 truncate">{driver.name}</h4>
                      ...
                      <div className="text-right">
                        <div className="flex items-center">
                          ...
                          <span className="ml-1 font-bold text-gray-800 text-lg">{driver.rating}</span>
                        </div>
                      </div>
                    ...
                    <div className="mb-4 flex items-center gap-10">
                      ...
                      <p className="text-gray-500 text-sm mt-0.5">{driver.trips} trajets</p>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      <div className="bg-gray-50 rounded-xl p-3">
                        ...
                        <p className="font-medium text-gray-800 text-sm truncate">{driver.vehicle}</p>
                      </div>
                      <div className="bg-gray-50 rounded-xl p-3">
                        <p className="text-xs text-gray-500 mb-1">Plaque</p>
                        <p className="font-medium text-gray-800 text-sm">{driver.plate}</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-lg font-bold text-gray-800">
                        <span className='text-gray-800'>GNF</span> {driver.earnings.toLocaleString()}
                      </p>
                    </div>
            ...
            <div className="flex justify-end mt-4">
              <div className="flex items-center space-x-2">
                <span className="text-gray-500 text-sm">Afficher par page:</span>
                <select
                  value={pageSize}
                  onChange={handlePageSizeChange}
                  className="border border-gray-200 rounded-lg px-3 py-1.5 text-sm outline-none focus:border-green-400 transition"
                >
