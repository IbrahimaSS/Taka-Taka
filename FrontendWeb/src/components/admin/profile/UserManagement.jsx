        ...
        <Card hoverable className="border-2 border-gray-100 hover:border-blue-100 transition-all duration-300">
          <CardContent className="p-6">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
              <div>
                <h2 className="text-2xl font-bold text-gray-800">Gestion des personnels</h2>
                <p className="text-gray-600">Gérez les accès et permissions des membres de l'équipe</p>
              </div>
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="flex-1 border-2 border-gray-200 rounded-xl px-4 py-2.5 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
                >
