// SearchIndicator.jsx - Indicateur flottant de recherche de chauffeur
import React from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { Car, Loader, X, Phone, Navigation, Check, User } from 'lucide-react';
...
const SearchIndicator = ({
  ...
  // Ne rien afficher si pas en recherche ou chauffeur trouvé
  if (status !== 'searching' && status !== 'driver_found' && status !== 'arrived') {
    return null;
  }
                  ...
                  <div>
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="flex items-center text-sm text-yellow-600 dark:text-yellow-400">
                        <span className="text-yellow-500 dark:text-yellow-400">★</span> {driver.rating}
                      </span>
                    </div>
