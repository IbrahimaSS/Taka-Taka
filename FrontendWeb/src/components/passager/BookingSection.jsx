// BookingSection.jsx - Version optimisée avec composants UI réutilisables
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-emerald-700 dark:text-emerald-400">{priceData?.price} GNF</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Prix estimé</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-gray-900 dark:text-white">{priceData?.distance} km</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Distance</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-gray-900 dark:text-white">{priceData?.duration} min</div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-r from-emerald-400 to-blue-500 flex items-center justify-center mr-4 shadow-lg">
                          <Car className="w-6 h-6 text-white" />
                        </div>
                        <div>
                          <h4 className="font-bold text-gray-900 dark:text-white">{currentDriver.name}</h4>
                          <p className="text-sm text-gray-600 dark:text-gray-400">{currentDriver.vehicle.plate}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="text-lg font-bold text-emerald-700 dark:text-emerald-400">{currentDriver.eta}</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">{currentDriver.distance}</div>
                      </div>
                    </div>
