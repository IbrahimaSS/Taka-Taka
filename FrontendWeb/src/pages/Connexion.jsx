...
const Connexion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast('Connexion r�ussie', 'Redirection vers votre tableau de bord...', 'success');

      if (role === 'driver' || role === 'chauffeur') navigate('/chauffeur');
      else if (role === 'passenger' || role === 'passager') navigate('/passager');
